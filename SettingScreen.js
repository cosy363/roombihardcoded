    ...
    <View style={{ flex: 10, alignItems: 'center', backgroundColor: "#F7F7F7", }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ marginTop: 110, marginLeft: 10}}>
          <Text style={{ fontSize: 35, fontWeight: "700", color: '#353535' }}>설정변경</Text>
        </View>
        ...
        <TouchableOpacity style={{ backgroundColor: "white", width: 360, height: 110, marginTop: 35, borderRadius: 30, }}
          ...
          <View style={{ flexDirection: 'row', marginTop: 20}}>
            ...
            <View>
              <Text style={{ fontSize: 23, fontWeight: '700', marginLeft: 15, marginTop: 17}}>예산 </Text>
        ...
        <TouchableOpacity style={{ backgroundColor: "white", width: 360, height: 110, marginTop: 15, borderRadius: 30, }}
          ...
          <View style={{ flexDirection: 'row', marginTop: 20}}>
            ...
            <View>
              <Text style={{ fontSize: 23, fontWeight: '700', marginLeft: 15, marginTop: 17}}>색 / 재질</Text>
        ...
        <TouchableOpacity style={{ backgroundColor: "white", width: 360, height: 110, marginTop: 15, borderRadius: 30, }}
          ...
          <View style={{ flexDirection: 'row', marginTop: 20}}>
            ...
            <View>
              <Text style={{ fontSize: 23, fontWeight: '700', marginLeft: 15, marginTop: 17}}>가구 </Text>
