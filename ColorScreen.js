...
import circle from './assets/color/Circle.png';
      ...
      <View style={styles.container2}>
        ...
        <View style={styles.dday2}>
         <View style={styles.dday}>
          ...
          <View style={styles.dday}>
            <Text style={styles.dcolorname}>     레드</Text>
            <Text style={styles.dcolorname}>                  그린</Text>
            <Text style={styles.dcolorname}>                  블루</Text>
          </View>
          ...
          <View style={styles.dday}>
            <Text style={styles.dcolorname}>    화이트</Text>
            <Text style={styles.dcolorname}></Text>
            <Text style={styles.dcolorname}>          블랙</Text>
            <Text style={styles.dcolorname}>                 우드</Text>
          </View>
  
        </View>

      <View style={{alignItems:'flex-end', marginTop:190,}}>
        <TouchableOpacity onPress={() => navigation.navigate('style')} activeOpacity={0.5} style={{opacity:0.7}}>
           <LinearGradient
